 ...
 */
final class Version20230426191807 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sale CHANGE external_sales_order_number external_sales_order_number INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sale CHANGE external_sales_order_number external_sales_order_number VARCHAR(255) NOT NULL');
