...
#[AsCommand(
        name: 'app:customer-cache',
        description: 'Cache Customer Data'   
    )]
class CustomerCacheCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        try
        {
            ...
            $value = $this->entityManager->getRepository(Customer::class)->findAll();
            $result = CustomerProfileHelper::dbProfileProcessor($value);
            $customerCache->set([$result]);
            $cache->save($customerCache);
