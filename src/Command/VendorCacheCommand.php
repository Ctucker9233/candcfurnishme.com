...
#[AsCommand(
        name: 'app:vendor-cache',
        description: 'Cache Vendor Data'   
    )]
class VendorCacheCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        try
        {
            ...
            $result = $this->vendorHelper->dbVendorProcessor($value);
            //dump($result);
            $vendorCache->set([$result]);
            $cache->save($vendorCache);
