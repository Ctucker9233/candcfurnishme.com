...
#[AsCommand(
        name: 'app:itemId-cache',
        description: 'Cache Item Id Data'   
    )]
class ItemIdCacheCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        try
        {
            ...
            $result = $this->inventoryHelper->dbItemIdProcessor($value, $vendor);
            //dump($result);
            $itemIdCache->set([$result]);
            $cache->save($itemIdCache);
